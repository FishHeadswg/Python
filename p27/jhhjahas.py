...
def ancestors(genealogy, person):
    if person in genealogy:
        ...
        for ancestor in parents:
            all_ancestors = all_ancestors + ancestors(genealogy, ancestor)
        return all_ancestors
    else:
        return []

# determine if person is in genealogy. If so:
# add ancestors of person to list of ancestors
# go through new list of ancestors and add their ancestors to the ancestor list using ancestor function
#
#
#
#
